...
import me.spiderdeluxe.mycteriaeconomy.models.npc.NPCTeller;
 ...
 */
public class NPCTellersCommandCreate extends SimpleSubCommand {

	public NPCTellersCommandCreate(final SimpleCommandGroup parent) {
		super(parent, "create");
	...
	public void onCommand() {
		...
		final NPCTeller npcTeller = new NPCTeller(npcName, NPCBase.createNPCUUID(), npcType, null);
		npcTeller.createNPC(location, modelName);
	...
	protected List<String> tabComplete() {
		return switch (args.length) {
			case 1 -> completeLastWordPlayerNames();
			case 2 -> completeLastWord(EntityType.values());
			case 3 -> completeLastWord(ModelEngineHook.registeredModels);
