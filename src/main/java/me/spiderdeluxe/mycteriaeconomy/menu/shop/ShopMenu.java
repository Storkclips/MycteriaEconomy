...
import me.spiderdeluxe.mycteriaeconomy.conversation.shop.ShopItemAmountPrompt;
import me.spiderdeluxe.mycteriaeconomy.conversation.shop.ShopItemDestroyPrompt;
import me.spiderdeluxe.mycteriaeconomy.conversation.shop.ShopItemSetupConversation;
import me.spiderdeluxe.mycteriaeconomy.conversation.shop.ShopRenamePrompt;
...
public class ShopMenu extends MenuShopPagged<ItemShop> {
	...
	public ShopMenu(final Shop shopMenu) {
		super(shopMenu.getItems());
		setSize(9 * 5);
		shop = shopMenu;
		shopMenu.updateShopItemsStock();
		setSound(new SimpleSound(Sound.valueOf(Settings.Menu.SHOP_ACTIVATION_SOUND),
				Settings.Menu.SHOP_ACTIVATION_VOLUME.floatValue(),
				Settings.Menu.SHOP_ACTIVATION_PITCH.floatValue()));
	...
	protected void onMenuClose(final Player player, final Inventory inventory) {
		...
		player.playSound(player.getLocation(),
				Sound.valueOf(Settings.Menu.SHOP_DEACTIVATION_SOUND),
				Settings.Menu.SHOP_DEACTIVATION_VOLUME.floatValue(),
				Settings.Menu.SHOP_DEACTIVATION_PITCH.floatValue());
